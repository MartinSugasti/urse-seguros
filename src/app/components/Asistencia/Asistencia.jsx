    ...
    <div className="container-lg py-5">
      <div className="row mx-0 justify-content-around align-items-center">
        <div className="col-12 col-md-4 text-center">
          ...
          <div className="links-container">
            <a href="#intro-home" className="accident-link btn btn-danger rounded-pill mt-2" alt="en-caso-de-accidente" data-bs-toggle="modal" data-bs-target="#accident-modal">
      ...
      <div className="row mx-0 justify-content-around align-items-center mt-5 mt-md-0">
        <div className="col-12 col-md-4 text-center">
          ...
          <div className="links-container">
            <a href="#intro-home" className="soa-link btn btn-outline-light rounded-pill mt-2" alt="certificado-soa" data-bs-toggle="modal" data-bs-target="#soa-modal">
