import calculatorImage from '../../../assets/images/intros/calculator.svg';

const IntroCotizacion = () => (
  <section id="intro-cotizacion" className="bg-light">
...
export default IntroCotizacion;
