    ...
    <div className="container-lg py-5">
      <div className="row mx-0 g-4 justify-content-around align-items-center">
        <div className="col-md-6 order-md-2 text-center mt-4 mt-md-0">
          <h1 className="text-dark mb-0">Seguro de Movilidad</h1>
          <p className="text-muted mb-2 fst-italic">Contrata tu seguro de movilidad alternativa de forma sencilla y ágil</p>
        </div>
